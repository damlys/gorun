...
module "test_lgtm_stack" {
  ...
  grafana_domain = "grafana.gogke-test-3.damlys.dev"
  grafana_email  = "grafana@gogke-test-3.damlys.dev"
}
...
module "test_prom_exporters" {
  ...
  blackbox_exporter_urls = [
    "https://grafana.gogke-test-3.damlys.dev/healthz",
    "https://stateful-kuard.gogke-test-3.damlys.dev/healthy",
    "https://stateless-kuard.gogke-test-3.damlys.dev/healthy",
  ]
}
